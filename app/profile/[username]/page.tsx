...
async function getUser(username: string) {
  const user = await prisma.user.findFirst({
    ...
    include: {
      snippets: {
        ...
        include: {
          likes: true,
          scripts: true, // Include scripts here
        },
      },
      badges: true,
      followers: {
  ...
  return {
    ...
    snippets: user.snippets.map((snippet) => ({
      ...
      description: snippet.description ?? undefined, // Ensure description is undefined if null
    })),
  };
}
  ...
  return (
    <>
      <SEO
        ...
        type="article" // Change this to a valid type
      />
